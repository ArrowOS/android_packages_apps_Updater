...
public class UpdatesActivity extends UpdatesListActivity {
    ...
    private static AsyncTask<UpdateInfo, Void, Map<String, String>> asyncTaskMirrors;
    ...
    /*public static void prepareSfMirrorsData (UpdateInfo updateInfo, UpdatesActivity mUpdatesActivity) {
        ...
        asyncTaskMirrors = new AsyncTask<UpdateInfo, Void, Map<String, String>>() {
            @Override
            ...
            protected Map<String, String> doInBackground(UpdateInfo... update) {
                ...
                UpdaterController.sourceforgeMirrors(update[0], sfRankSort);

                while (true) {
                    if (UpdaterController.killIt) break;
                }

                if (sfRankSort)
                    return UpdaterController.sorted_sf_mirrors;
                else
                    return UpdaterController.mirror_links;
            }
            ...
            protected void onPostExecute(Map<String, String> sf_mirrors) {
                ...
                if (!sf_mirrors.isEmpty()) {
                    ...
                    asyncTaskMirrors.cancel(true);
                }
            }
        };
        asyncTaskMirrors.executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, updateInfo);
    }*/

    public static void prepareSfMirrorsData (UpdateInfo updateInfo, UpdatesActivity mUpdatesActivity) {
        boolean sfRankSort = Utils.getSfRankSortSetting(mUpdatesActivity);
        Map<String, String> sf_mirrors;
        ...
        UpdaterController.sourceforgeMirrors(updateInfo, sfRankSort);
        ...
        if (sfRankSort)
            sf_mirrors = UpdaterController.sorted_sf_mirrors;
        else
            sf_mirrors = UpdaterController.mirror_links;
