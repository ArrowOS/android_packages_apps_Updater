        ...
        try {
            if (Utils.isABUpdate(zipFile)) {
                ...
                new Thread() {
                    public void run() {
                        try {
                            if (installer.mLocalUpdateFile.exists())
                                installer.mLocalUpdateFile.delete();
                            FileUtils.copyFile(zipFile, installer.mLocalUpdateFile);
                            installer.installPackage(mContext, installer.mLocalUpdateFile);
